...
@Entity
@Table(name = "traffic_data_test")
public class TrafficDataTest extends TrafficData {
    ...
    public TrafficDataTest(TrafficData data, String attackType) {
        ...
        // Add any additional fields specific to TrafficDataTest if needed
    }
}
